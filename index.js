 ...
 * @LastEditors: lvy lvy
 * @LastEditTime: 2023-04-08 22:02:03
...
let initWebgl = function () {
  ...
  setUniform(gl, program, {
    ...
    'mProj': mat4.perspective((new Float32Array(16)), glMatrix.toRadian(45), canvas.clientWidth / canvas.clientHeight, 0.1, 1000.0),
  ...
  var loop = function () {
    ...
    //[1,0,0] x轴转动
    mat4.rotate(worldMatrix, identityMatrix, angle / 4, [1, 0, 0]);
